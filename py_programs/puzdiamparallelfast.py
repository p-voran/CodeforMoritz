    ...
    while 1:
        ...
        if len(to_do) < 800:
            ...
            for i in range(7):
                ...
                proc = multiprocessing.Process(target = mp_one_step, args = (my_queue, chunk, res, facecollection))
                procs.append(proc)
                proc.start()
...
def mp_one_step(queue, inputs, res, facecollection):
    next_step = []
...
if __name__ == '__main__':
    finaloutput = calculateConfigurations(start43, 4, 3)
